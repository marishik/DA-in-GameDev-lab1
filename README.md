...
Я построила графики зависимости количества эпох от ошибки обучения - брала 6 попыток и 8 эпох. 
![изображение](https://user-images.githubusercontent.com/114138439/205047638-883d7671-0f17-48ed-8c89-ca2d8d20e4b9.png)
![изображение](https://user-images.githubusercontent.com/114138439/205047357-a1b407f3-ff6d-430c-b292-f4da6bffcc8d.png)
![изображение](https://user-images.githubusercontent.com/114138439/205048060-6c14980d-aaf3-4d47-b06c-9342dd5aa5b0.png)
![изображение](https://user-images.githubusercontent.com/114138439/205048579-d8adea72-e98a-4d30-adc5-d51e144912bf.png)

Необходимое количество эпох обучения зависит от решаемой задачи и от ошибки, получаемой на выходе. Если в итоге при заданном количестве эпох возникает ошибка - количество эпох необходимо увеличить

## Выводы

В ходе лабораторной работы я познакомилась с кодом для работы перцептрона и с его работой на практике при помощи Unity, обучила перцептрон логическим операциям OR, AND, NAND и попыталась обучить его логической операции XOR, в результате чего был сделан вывод, что при одном перцептроне сделать это невозможно. Также были построены графики зависимости количества эпох от ошибки обучения, изучен вопрос того, от чего зависит необходимое количество эпох обучения. 
